...
- Update server URL in [src/Pianoteq.Pwa/Program.cs](src/Pianoteq.Pwa/Program.cs#L15) if not at `http://192.168.86.30:8081`
...
using var client = new PianoteqClient("http://192.168.86.30:8081");
...
{
    return new PianoteqClient(httpClient, "http://192.168.86.30:8081");
});
```
